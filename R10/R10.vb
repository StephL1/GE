...
egood:
    ...
    Private Sub dbutton3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles dbutton3.Click
        ...
        lblnumaudit.Text = pieces_audited(whichln)
        Distinct_Pieces_Audited(4)

    End Sub

  
    Private Sub info_bar_TextChanged(sender As System.Object, e As System.EventArgs) Handles info_bar.TextChanged

    End Sub

    Private Sub skid_box_TextChanged(sender As Object, e As EventArgs) Handles skid_box.TextChanged
